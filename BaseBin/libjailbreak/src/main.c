...
int jbclient_initialize_primitives_internal_jumo(bool physrwPTE)
{
	if (getuid() != 0) return -1;
...
int jbclient_initialize_primitives_jumo(void)
{
	return jbclient_initialize_primitives_internal_jumo(false);
}
...
// Used for supporting third party legacy software that still calls this function
int jbdInitPPLRW_h=jumo(void)
{
	return jbclient_initialize_primitives_jumo();
}
